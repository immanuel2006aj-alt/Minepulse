...
async def report_hashrate(report: HashrateReport):
    ...
    try:
        # Check if this is the first report of the day for this user
        ...
        if not existing.data:
            # First report of the day – send "started mining" telegram
            send_telegram(f"⛏️ <b>{username}</b> started mining for today!")
