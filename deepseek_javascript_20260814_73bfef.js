// ============================================================
// MINEPULSE – APP.JS (v3 – with Notifications, Render Backend)
// ============================================================

// ---------- CONFIG ----------
const CONFIG = {
  SUPABASE_URL: 'https://rwdkpjtrqmcildnhccwg.supabase.co',   // REPLACE
  SUPABASE_ANON_KEY: 'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6InJ3ZGtwanRycW1jaWxkbmhjY3dnIiwicm9sZSI6ImFub24iLCJpYXQiOjE3ODY2Mjg4MzIsImV4cCI6MjEwMjIwNDgzMn0.qpkXHXCKoUA3hFGRgrZNkYHvvhwOUJKHDXcmvoS7w4Y', // REPLACE
  API_BASE: 'https://minepulse-backend.onrender.com', // Render backend
};
...
function toggleMining() {
  ...
  // For now, just toggle UI – WebSocket will be implemented later.
  if (state.isMining) {
    state.isMining = false;
    $('mining-btn').textContent = 'START MINING';
    $('mining-btn').classList.remove('active');
...
function renderNotifications() {
  // This is now handled by notification.html
  // We only keep the dot update here.
  updateNotifDot();
}
...
async function init() {
  ...
  console.log('MinePulse v3 initialized with Render backend and Notifications.');
}
