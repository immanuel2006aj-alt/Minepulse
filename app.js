...
// Fixed: initChimera now uses navigator.serviceWorker.ready.
// ============================================================
...
// ============================================================
// FIXED: CHIMERA WORKER INITIALIZATION
// ============================================================
async function initChimera() {
  ...
  if ('serviceWorker' in navigator) {
    try {
      // Register the worker (if not already)
      ...
      if (worker) {
        ...
        console.warn('[App] No active worker found after ready.');
      }
    } catch (e) {
